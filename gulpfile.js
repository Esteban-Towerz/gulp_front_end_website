...
gulp.task('lint', function () {
  ...
  // to see the gulp process hhalt on error, change the following eslint rules to
...
gulp.task('scripts', ['concatScripts'], function (cb) {
  // pump to handle error conditions with Node streams
  pump([
      gulp.src('js/all.js'),
      // minifies js file
      uglify(),
